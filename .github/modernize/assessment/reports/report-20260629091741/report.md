...
- `./DataLoader/DataLoader/App.config`
...
| NuGet package upgrade is recommended | Potential | 1 | [7](#NuGet_package_upgrade_is_recommended) |
...
| NuGet package contains security vulnerability | Optional | 1 | [5](#NuGet_package_contains_security_vulnerability) |
...
- `DataLoader/DataLoader/DataLoader.csproj`
- `NYCJobsWeb/NYCJobsWeb.csproj`
